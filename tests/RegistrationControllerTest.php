...
class RegistrationControllerTest extends WebTestCase
{
    ...
    public function testRegister(): void
    {
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'riva.matteo.pro@gmail.com');
        ...
        self::assertTrue(static::getContainer()->get(SecurityUserRepository::class)->findAll()[0]->isVerified());
    }
}
